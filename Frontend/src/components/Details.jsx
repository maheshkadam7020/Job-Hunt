          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="text-center lg:text-left">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3 mt-5">
                ...
                <Badge className="bg-red-100 text-red-600 hover:bg-red-100 px-4 py-1.5 rounded-full text-sm">
                  {singlejob?.jobtype || "Part Time"}
                </Badge>

                <Badge className="bg-purple-100 text-purple-700 hover:bg-purple-100 px-4 py-1.5 rounded-full text-sm">
                  {singlejob?.salary
